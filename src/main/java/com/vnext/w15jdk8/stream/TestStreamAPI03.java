...
import com.vnext.w15jdk8.stream.Employee.Status;
...
public class TestStreamAPI03 {
    ...
    public void test3(){
        List<String> list = emps.stream()
                .map(Employee::getName)
                .collect(Collectors.toList()); // Collectors,将名字收集成list
    ...
    public void test5(){
        ...
        System.out.println("-----------------------------------");
        Set<Map.Entry<Status, List<Employee>>> entries = map.entrySet();
